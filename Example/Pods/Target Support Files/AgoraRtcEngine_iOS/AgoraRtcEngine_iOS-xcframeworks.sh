...
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraAIDenoiseExtension.xcframework" "AgoraAIDenoiseExtension" "framework" "ios-armv7_arm64" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraRtcKit.xcframework" "AgoraRtcKit" "framework" "ios-x86_64-simulator" "ios-armv7_arm64"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/Agoraffmpeg.xcframework" "Agoraffmpeg" "framework" "ios-armv7_arm64" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraCore.xcframework" "AgoraCore" "framework" "ios-armv7_arm64" "ios-x86_64-simulator"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraSoundTouch.xcframework" "AgoraSoundTouch" "framework" "ios-x86_64-simulator" "ios-armv7_arm64"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/Agorafdkaac.xcframework" "Agorafdkaac" "framework" "ios-x86_64-simulator" "ios-armv7_arm64"
install_xcframework "${PODS_ROOT}/AgoraRtcEngine_iOS/AgoraDav1dExtension.xcframework" "AgoraDav1dExtension" "framework" "ios-x86_64-simulator" "ios-armv7_arm64"
